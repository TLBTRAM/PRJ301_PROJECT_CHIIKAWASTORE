...
<html>
    ...
    <body>
        ...
        <div class="page-content">
            ...
            %>
            <%
                ProductDTO ptdo = new ProductDTO();
                try {
                    ptdo = (ProductDTO) request.getAttribute("product");
                } catch (Exception e) {
                    ptdo = new ProductDTO();
                }
                if (ptdo == null) {
            ...
            <div class="form-container">
                ...
                <form action="MainController" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="txtTitle" name="txtTitle" value="<%=ptdo.getTitle()%>"/>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="txtPrice" name="txtPrice" value="<%=ptdo.getPrice()%>"/>
                    </div>

                    <div class="form-group">
                        <label for="txtQuantity">Quantity:</label>
                        <input type="number" id="txtQuantity" name="txtQuantity" value="<%=ptdo.getQuantity()%>"/>
