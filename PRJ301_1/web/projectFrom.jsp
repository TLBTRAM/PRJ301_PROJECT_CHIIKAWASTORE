            ...
            <div class="form-container">
                ...
                <form action="MainController" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="txtProductID" name="txtProductID" value="<%=ptdo.getProject_id()%>"/>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="txtStatus" name="txtStatus" value="<%=ptdo.getStatus()%>"/>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="txtEstimateLaunch" name="txtEstimateLaunch" value="<%=ptdo.getEstimated_launch()%>"/>
                    </div>
